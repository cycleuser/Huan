...
class SinglePageArchiver:
    ...
    def _html_to_markdown(self, html, url, md_filepath):
        ...
        # Use heuristic extraction to preserve images
        ...
        for info in img_info_list:
            ...
            # Check if image is already in the markdown (heuristic extraction preserved it)
            if rel_path in md_body:
                continue
            inserted = False
